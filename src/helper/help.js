...
function displayHelp() {
    ...
    console.log(chalk_1.default.cyan('1. Search for a Manga:'));
    console.log('   - Start the CLI and type your search query.');
    console.log('   - A list of manga will appear.\n');
    console.log(chalk_1.default.cyan('2. Navigate Lists:'));
    ...
    console.log(chalk_1.default.cyan('3. Reading Chapters:'));
